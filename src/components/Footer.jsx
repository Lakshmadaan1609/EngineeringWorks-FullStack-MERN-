...
const Footer = () => (
  <footer className="bg-black bg-gradient-to-t from-gray-900 to-black text-gray-200 pt-12 pb-6 mt-12 border-t border-gray-800 shadow-inner">
    <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-10 md:gap-0">
      {/* Company Info */}
      <div className="text-center md:text-left max-w-xs">
        <h2 className="text-2xl font-extrabold text-white mb-3 tracking-wide">EngineerWorks</h2>
      ...
      <div className="flex gap-5 items-center">
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors duration-200 bg-gray-800 p-2 rounded-full shadow hover:scale-110">
          <FiInstagram size={24} />
        </a>
        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors duration-200 bg-gray-800 p-2 rounded-full shadow hover:scale-110">
          <FiLinkedin size={24} />
        </a>
        <a href="mailto:info@engineerworks.com" className="hover:text-green-400 transition-colors duration-200 bg-gray-800 p-2 rounded-full shadow hover:scale-110">
          <FiMail size={24} />
        </a>
      </div>
    </div>
    <div className="mt-10 border-t border-gray-700 pt-5 text-center text-xs text-gray-500 tracking-wide">
